...
在你不断使用能力的过程中，技能熟练度和最大CP（计算力）会逐渐提升。成功开发更高等级的技能后，你的能力等级会提升到该技能的等级。高等级技能具有更严格的前置条件，并可能要求更高级的能力开发机。
...
P.S. 数据终端的__设置App__会显示当前键位；如需修改，请前往 Minecraft 的“选项—控制”界面调整 AcademyCraft 键位。
...
将高压磁增幅线圈放入高级能力开发机的线圈槽，将目标能力的诱导因子放入因子槽，然后点击界面中的“重置能力”按钮。

重置完成后，能力会变为诱导因子所具有的能力，能力等级会降一级，因此只有至少达到强能力者（Level 3）才能重置。目标诱导因子不能与当前能力相同。
