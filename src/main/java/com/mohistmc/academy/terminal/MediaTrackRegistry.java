...
public class MediaTrackRegistry {
    ...
    private static void registerBuiltins() {
        ...
        register(new MediaTrack("only_my_railgun",
                ...
                ResourceLocation.fromNamespaceAndPath(AcademyCraft.MODID, "textures/item/media_only_my_railgun.png"),
        ...
        register(new MediaTrack("level5_judgelight",
                ...
                ResourceLocation.fromNamespaceAndPath(AcademyCraft.MODID, "textures/item/media_level5_judgelight.png"),
        ...
        register(new MediaTrack("sisters_noise",
                ...
                ResourceLocation.fromNamespaceAndPath(AcademyCraft.MODID, "textures/item/media_sisters_noise.png"),
