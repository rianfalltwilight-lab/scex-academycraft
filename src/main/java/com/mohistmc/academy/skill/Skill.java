...
public class Skill {
    ...
    public boolean hasLegacyTreePosition() { return Double.isFinite(treeX) && Double.isFinite(treeY); }
    public double getTreeX() { return treeX; }
    public double getTreeY() { return treeY; }
    ...
    public static class Builder {
        ...
        private double treeX = Double.NaN;
        private double treeY = Double.NaN;
        ...
        public Skill build() {
            return new Skill(id, category, level, type, prerequisites, baseCpCost, baseOverload, treeX, treeY);
        }
    }
}
