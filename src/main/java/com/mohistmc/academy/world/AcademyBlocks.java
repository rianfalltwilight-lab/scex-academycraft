...
import com.mohistmc.academy.world.block.MagManipEscrowBlock;
...
import com.mohistmc.academy.world.block.RfInputBlock;
import com.mohistmc.academy.world.block.RfOutputBlock;
...
public class AcademyBlocks {
    ...
    // Deliberately has no BlockItem: it is an internal crash-consistency receipt.
    public static final DeferredBlock<Block> MAG_MANIP_ESCROW = BLOCKS.register("mag_manip_escrow", MagManipEscrowBlock::new);
    ...
    public static final DeferredBlock<Block> ABILITY_INTERFERER = BLOCKS.register("ability_interferer", () -> new AbilityInterferer());
    ...
    public static final DeferredBlock<Block> SOLAR_GEN = BLOCKS.register("solar_gen", () -> new SolarGen(Properties.of()
            ...
            .strength(4.0f)
            .requiresCorrectToolForDrops()));
    public static final DeferredBlock<Block> RF_INPUT = BLOCKS.register("rf_input", () -> new RfInputBlock(Properties.of()
            .sound(SoundType.STONE)
            .strength(2.5f)
            .requiresCorrectToolForDrops()));
    public static final DeferredBlock<Block> RF_OUTPUT = BLOCKS.register("rf_output", () -> new RfOutputBlock(Properties.of()
            .sound(SoundType.STONE)
            .strength(2.5f)
            .requiresCorrectToolForDrops()));
