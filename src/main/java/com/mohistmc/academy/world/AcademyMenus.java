...
public class AcademyMenus {
    ...
    public static final Supplier<MenuType<AbilityInterfererMenu>> ABILITY_INTERFERER_MENU = MENUS.register("ability_interferer_menu", () -> IMenuTypeExtension.create(AbilityInterfererMenu::new));
    ...
    public static final Supplier<MenuType<EnergyBridgeMenu>> ENERGY_BRIDGE_MENU = MENUS.register("energy_bridge_menu", () -> IMenuTypeExtension.create(EnergyBridgeMenu::new));
