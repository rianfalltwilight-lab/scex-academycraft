...
public class AcademyCraft {
    ...
    public static final String NETWORK_PROTOCOL = "academy-1.21.1-payload-v18-data-v4";
    ...
    private void registerPayloads(final RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToClient(com.mohistmc.academy.network.MatrixConfigResultPacket.TYPE,
                com.mohistmc.academy.network.MatrixConfigResultPacket.STREAM_CODEC,
                com.mohistmc.academy.network.MatrixConfigResultPacket::handle);
